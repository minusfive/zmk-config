...
| `! @ # $ %`<br/>`^ & * ( )`                                                                                           | `1 2 3 4 5`<br/>`6 7 8 9 0`                                                                                                             | symbols maintain their standard ANSI association with numbers; replicated as combos on `L1` retaining position relative to numbers on `L2`                                                                     |
| `-_  =+`<br/>`[{  ]}  \|\`                                                                                            | relative position                                                                                                                       | this key cluster retains their order/position relative to each other on Apple keyboards, but is to vertical combos more easily accessible to stronger fingers.                                                 |
